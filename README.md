...
[![](https://img.shields.io/badge/Email-%20rifadof@gmail.com-blue?style=flat&logo=mail.ru)](mailto:rifadof@gmail.com)
[![](https://img.shields.io/badge/LinkedIn-%40rifad-blue?style=flat&logo=linkedin)](https://www.linkedin.com/in/rifad-m/)
...
##  Projects (high-level)
- [web_automation_BDD](https://github.com/donrifad/web_automation_BDD) — Java-based BDD automation framework for robust web UI testing with modular step design and CI integration.  
- [python-bdd-api-framework](https://github.com/donrifad/python-bdd-api-framework) — Python BDD framework focused on API validation, reusable fixtures, and clear reporting.  
- [cypress_frontend_automation](https://github.com/donrifad/cypress_frontend_automation) — Frontend E2E automation with Cypress, parallel execution, and stable test patterns.  
- [Ensek_API](https://github.com/rifadofuk/Ensek_API.git) — C#-based BDD implementation for API scenarios and integration testing.
...
- Email: [rifadof@gmail.com](mailto:rifadof@gmail.com)  
- LinkedIn: [Rifad M](https://www.linkedin.com/in/rifad-m/)  
